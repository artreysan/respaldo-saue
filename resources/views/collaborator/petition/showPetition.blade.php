                    ...
                    <div>
                        <h4><strong>Solicitud:
                                ...
                                switch ($petition->status) {
                                    case 0:
                                        echo '<div class="far fa-circle pendiente"><strong> Pendiente </strong></div>';
                                        break;
                                    case 1:
                                        echo '<div class="far fa-circle en-proceso"><strong> En proceso </strong></div>';
                                        break;
                                    case 2:
                                        echo '<div class="far fa-circle atendida"><strong> Atendida </strong></div>';
                                        break;
                                    case 3:
                                        echo '<div class="far fa-circle validada"><strong> Validada </strong></div>';
                                        break;
                                }
                                ?></strong></h4>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            @if ($petition->collaborator->nodo == '')
                                ...
                                @endif
                            @else
                                <h6 style="color:gold" >{{ 'Atendida'}}<h6>
                            @endif
                        </div>
                    </div>
                    <br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                             @if ($petition->collaborator->internet == '')
                                ...
                                @endif
                            @else
                                <h6 style="color:gold" >{{ 'Atendido'}}<h6>
                            @endif
                        </div>
                    </div>
                    <div class="row">
